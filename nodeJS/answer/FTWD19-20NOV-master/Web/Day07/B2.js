...
let playerJim = new Player({name: 'Jim', health: 100}); //initialize players
let playerThor = new Player({name: 'Thor', health: 100});
...
console.log(fightToTheDeath (playerJim, playerThor));