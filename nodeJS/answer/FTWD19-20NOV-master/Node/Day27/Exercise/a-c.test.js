...
describe('starwars duel testing', () => {
    ...
    beforeEach(() => {
        ...
        spyFakeAnakinAttack = jest.spyOn(fakeAnakin, 'attack').mockImplementation(() => { console.log('Mock Anakin Attack'); return "hes been hit";});
        spyFakeObiwanAttack = jest.spyOn(fakeObiwan, 'attack').mockImplementation(() => { console.log('Mock Obiwan Attack') });

        spyFakeAnakinInjure = jest.spyOn(fakeAnakin, 'injure').mockImplementation(() => { console.log('Mocked Injure') })
        spyFakeAnakinDead = jest.spyOn(fakeAnakin, 'dead').mockImplementation(() => { console.log('Mocked Anakin death') })
    ...
    test('to see if the methods within the duel function have been called.', () => {
        ...
        expect(fakeAnakin.attack(fakeObiwan)).toBe('hes been hit');
