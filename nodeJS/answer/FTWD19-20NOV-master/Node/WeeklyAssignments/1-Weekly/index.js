...
app.post('/files',  (req, res)=>{ // after the request path upload.single('upload'),
console.log(req.files)

// This is for multiple upload using multer, dont confuse yourselves here. 
...
//         caches[file].then(()=> res.send('Wow you sent a file, can you remember how to download it? Goto your browser, url: localhost:3000/uploaded/:file-name'))
